...
<html lang="en">
                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">      
                            <span class="chapter-title">InstaClass</span>
                        </div>
            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion">
                    ...
                    <li class="no-padding active">
                        ...
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="miscellaneous-sweetalert.html" class="active-page">Sweet Alert</a>
            ...
            <main class="mn-inner">
                <div class="row">
                    ...
                    <div class="col s12 m4 l4">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Basic Message</span>
                                <a class="waves-effect waves-light btn blue m-b-xs sweetalert-basic">Try me!</a>
                                <pre>swal("Here's a message!")</pre>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Warning Message</span>
                                <a class="waves-effect waves-light btn blue m-b-xs sweetalert-warning">Try me!</a>
                                <pre>swal({   
    title: "Are you sure?",   
    ...
    swal("Deleted!", "Your imaginary file has been deleted.", "success"); 
                        ...
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">HTML message</span>
                                <a class="waves-effect waves-light btn blue m-b-xs sweetalert-html">Try me!</a>
                                <pre>swal({   
    ...
    html: true 
                    ...
                    <div class="col s12 m4 l4">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">With Text</span>
                                <a class="waves-effect waves-light btn blue m-b-xs sweetalert-text">Try me!</a>
                        ...
                        <div class="card">
                            <div class="card-content">
                                ...
                                <a class="waves-effect waves-light btn blue m-b-xs sweetalert-cancel">Try me!</a>
                                <pre>swal({   
    title: "Are you sure?",
    text: "You will not be able to recover this imaginary file!",
    type: "warning",
    ...
    if (isConfirm) {
        ...
        swal("Cancelled", "Your imaginary file is safe :)", "error");
                        ...
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Auto Close Timer</span>
                                <a class="waves-effect waves-light btn blue m-b-xs sweetalert-timer">Try me!</a>
                                <pre>swal({   
    ...
    showConfirmButton: false 
                    ...
                    <div class="col s12 m4 l4">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Success Message</span>
                                <a class="waves-effect waves-light btn blue m-b-xs sweetalert-success">Try me!</a>
                                <pre>swal("Good job!", "You clicked the button!", "success")</pre>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Custom Icon</span>
                                <a class="waves-effect waves-light btn blue m-b-xs sweetalert-icon">Try me!</a>
                                <pre>swal({
    title: "Sweet!",   
    ...
    imageUrl: "assets/images/thumbs-up.jpg" 
                        ...
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">With Input</span>
                                <a class="waves-effect waves-light btn blue m-b-xs sweetalert-input">Try me!</a>
                                <pre>swal({   
    title: "An input!",  
