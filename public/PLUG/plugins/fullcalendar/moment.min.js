//! moment.js //! version : 2.9.0 //! authors : Tim Wood, Iskren Chernev, Moment.js contributors //! license : MIT //! momentjs.com (function(a) {
    function b(a, b, c) {
    ...
    function n(a) {
        ...
        this._milliseconds=+k+1e3*j+6e4*i+36e5*h, this._days=+g+7*f, this._months=+e+3*d+12*c, this._data= {
        }
    ...
    function K(a) {
        ...
        f<a.length;
            ...
            for(e=J(a[f]).split("-"), b=e.length, c=J(a[f+1]), c=c?c.split("-"):null;
            b>0;
            ) {
